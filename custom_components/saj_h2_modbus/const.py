...
total_increasing_energy_sensors = [
    ...
    {"name": "Sum All Phases Feed-In Total", "key": "sum_feed_in_total", "enable": True, "icon": "transmission-tower"},
    {"name": "Sum All Phases Sell Total", "key": "sum_sell_total", "enable": True, "icon": "currency-usd"},
...
battery_schedule_sensors = [
    {"name": "Charge Start Time", "key": "charge_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge End Time", "key": "charge_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge Day Mask", "key": "charge_day_mask", "icon": "calendar", "enable": True},
    {"name": "Charge Power Percent", "key": "charge_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # Second charge slot
    {"name": "Charge 2 Start Time", "key": "charge2_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 2 End Time", "key": "charge2_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 2 Day Mask", "key": "charge2_day_mask", "icon": "calendar", "enable": True},
    {"name": "Charge 2 Power Percent", "key": "charge2_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # Third charge slot
    {"name": "Charge 3 Start Time", "key": "charge3_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 3 End Time", "key": "charge3_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 3 Day Mask", "key": "charge3_day_mask", "icon": "calendar", "enable": True},
    {"name": "Charge 3 Power Percent", "key": "charge3_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # Fourth charge slot
    {"name": "Charge 4 Start Time", "key": "charge4_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 4 End Time", "key": "charge4_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 4 Day Mask", "key": "charge4_day_mask", "icon": "calendar", "enable": True},
    {"name": "Charge 4 Power Percent", "key": "charge4_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # Fifth charge slot
    {"name": "Charge 5 Start Time", "key": "charge5_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 5 End Time", "key": "charge5_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 5 Day Mask", "key": "charge5_day_mask", "icon": "calendar", "enable": True},
    {"name": "Charge 5 Power Percent", "key": "charge5_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # Sixth charge slot
    {"name": "Charge 6 Start Time", "key": "charge6_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 6 End Time", "key": "charge6_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 6 Day Mask", "key": "charge6_day_mask", "icon": "calendar", "enable": True},
    {"name": "Charge 6 Power Percent", "key": "charge6_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # Seventh charge slot
    {"name": "Charge 7 Start Time", "key": "charge7_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 7 End Time", "key": "charge7_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Charge 7 Day Mask", "key": "charge7_day_mask", "icon": "calendar", "enable": True},
    {"name": "Charge 7 Power Percent", "key": "charge7_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # Discharge slots
    {"name": "Discharge Start Time", "key": "discharge_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge End Time", "key": "discharge_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge Day Mask", "key": "discharge_day_mask", "icon": "calendar", "enable": True},
    {"name": "Discharge Power Percent", "key": "discharge_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    # ...existing discharge 2-7 and passive entries with enable: True...
    {"name": "Discharge 2 Start Time", "key": "discharge2_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 2 End Time", "key": "discharge2_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 2 Day Mask", "key": "discharge2_day_mask", "icon": "calendar", "enable": True},
    {"name": "Discharge 2 Power Percent", "key": "discharge2_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    {"name": "Discharge 3 Start Time", "key": "discharge3_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 3 End Time", "key": "discharge3_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 3 Day Mask", "key": "discharge3_day_mask", "icon": "calendar", "enable": True},
    {"name": "Discharge 3 Power Percent", "key": "discharge3_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    {"name": "Discharge 4 Start Time", "key": "discharge4_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 4 End Time", "key": "discharge4_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 4 Day Mask", "key": "discharge4_day_mask", "icon": "calendar", "enable": True},
    {"name": "Discharge 4 Power Percent", "key": "discharge4_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    {"name": "Discharge 5 Start Time", "key": "discharge5_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 5 End Time", "key": "discharge5_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 5 Day Mask", "key": "discharge5_day_mask", "icon": "calendar", "enable": True},
    {"name": "Discharge 5 Power Percent", "key": "discharge5_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    {"name": "Discharge 6 Start Time", "key": "discharge6_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 6 End Time", "key": "discharge6_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 6 Day Mask", "key": "discharge6_day_mask", "icon": "calendar", "enable": True},
    {"name": "Discharge 6 Power Percent", "key": "discharge6_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    {"name": "Discharge 7 Start Time", "key": "discharge7_start_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 7 End Time", "key": "discharge7_end_time", "icon": "clock-outline", "enable": True},
    {"name": "Discharge 7 Day Mask", "key": "discharge7_day_mask", "icon": "calendar", "enable": True},
    {"name": "Discharge 7 Power Percent", "key": "discharge7_power_percent", "icon": "flash", "unit_of_measurement": "%", "enable": True},
    {"name": "Passive Charge Enable", "key": "passive_charge_enable", "icon": "power-settings", "enable": True},
    {"name": "Passive Grid Charge Power", "key": "passive_grid_charge_power", "icon": "transmission-tower", "unit_of_measurement": "%", "enable": True},
    {"name": "Passive Grid Discharge Power", "key": "passive_grid_discharge_power", "icon": "transmission-tower", "unit_of_measurement": "%", "enable": True},
    {"name": "Passive Battery Charge Power", "key": "passive_bat_charge_power", "icon": "battery-charging", "unit_of_measurement": "%", "enable": True},
    {"name": "Passive Battery Discharge Power", "key": "passive_bat_discharge_power", "icon": "battery", "unit_of_measurement": "%", "enable": True},
]
